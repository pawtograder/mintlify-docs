...
<CardGroup cols={2}>
  ...
  <Card title="Deployment Skinning" icon="palette" href="/developers/deployment-skinning">
    Re-brand a self-hosted deployment with a custom name, logo, colors, and SSO buttons.
  </Card>
