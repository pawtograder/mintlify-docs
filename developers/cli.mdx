...
The CLI is published to npm as [`@pawtograder/cli`](https://www.npmjs.com/package/@pawtograder/cli):
...
Build and smoke-test the published bundle locally:
...
List and assign peer and grading review assignments:
...
# Assign grading work (balanced round-robin, dry run first)
