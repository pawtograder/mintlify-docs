...
- A poll stays open until your instructor closes it — polls do not close on their own, even long-running ones
...
- Your instructor closed it — this is the only way a poll closes
