...
<Note>
If your instructor extends the assignment due date, your self-review deadline will automatically be extended as well, maintaining the same relative offset from the new due date.
</Note>
