...
<Note>
If your instructor extends the assignment due date, your self-review deadline will automatically adjust to maintain the same relative offset from the new due date.
</Note>
