...
<Note>
When finalizing your submission early to start the self-review, late tokens will not be automatically deducted. Late tokens are only consumed when you explicitly apply them to extend your deadline.
</Note>
