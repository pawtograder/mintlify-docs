...
<Note>
If you finalize your submission early while late tokens are active for the assignment, you will not be able to use late tokens to extend the deadline. Finalize your submission early only if you are certain you will not need additional time.
</Note>
