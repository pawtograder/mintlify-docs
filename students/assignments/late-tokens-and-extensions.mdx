...
On each assignment page where late tokens can be applied, you'll see an **Extend Due Date** button (or **Extend Resubmission Deadline** in courses that use the suggested due date feature) next to your due date.

<Note>
Late tokens always extend the hard deadline — the date after which submissions close entirely. In courses that display a suggested due date as the primary "Due" date, the button is labeled **Extend Resubmission Deadline** to make clear which date is being extended.
</Note>
