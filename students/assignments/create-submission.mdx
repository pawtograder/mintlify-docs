...
<Note>
Pawtograder uses the time when your code was pushed to GitHub to determine if a submission is late, not the current time. This ensures fair and consistent late detection even if the autograder runs with a delay.
</Note>
