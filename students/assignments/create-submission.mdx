...
If your autograder produces artifacts (such as test output, logs, or generated files), you can view them directly in Pawtograder. The system supports rendering plaintext and markdown artifacts, making it easy to review detailed test results or documentation generated during grading.
