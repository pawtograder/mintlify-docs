...
Once an assignment has been released by your instructor, you'll see it in the **Assignments** tab. Assignments that have not yet reached their release date are hidden from the list until they are released. A link to your GitHub repository for the assignment appears at the top of the assignment page. This repository is private, and only you and the course staff can see it.
