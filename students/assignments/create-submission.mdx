...
## Repository-based assignments

For most assignments, a link to your GitHub repository appears at the top of the assignment page. This repository is private, and only you and the course staff can see it.
...
Some assignments do not use a GitHub repository. Instead, you upload your submission files directly through Pawtograder:

1. On the assignment page, drag and drop your files onto the upload area, or click it to choose files.
2. Review the list of selected files, then click **Upload submission**.
3. Each upload creates a new active submission. You can upload again to replace it.

## No-submission assignments

For presentations, oral exams, or other manually graded work, the assignment page shows a notice that no submission is required. Complete the task as your instructor described — your grade will appear once it is released.

## Pull request assignments

Some assignments ask you to open a pull request against the course's upstream repository rather than pushing to your own repository. The assignment page explains which repository to target and which branch to use.

Once you open the PR, it appears on the assignment page as a candidate submission. If you have more than one candidate PR, click **This is my submission** next to the correct one to confirm it. Each push to your confirmed PR is recorded as a new submission version automatically.
