...
- **N/A**: For assignments without an autograder (file upload, no-submission, or PR-mode assignments)
...
For Git repository assignments, every push automatically runs your autograder. The submission page may show a preview of the grading rubric (if enabled by your instructor) and a summary of the autograder results.
