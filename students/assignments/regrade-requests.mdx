...
Locate the specific rubric check you want to dispute. Each check has either a **Request regrade** button (if the check was applied and you want it reconsidered) or a **Request regrade — check not applied** button (if you believe a check should have been applied to your submission but wasn't). You can request a regrade on a check that was never applied — for example, if you believe you should have received credit for a rubric item the grader left blank.
</Step>
