...
If a grader deletes or changes the rubric check that your open regrade request was about (for example, during a re-grade of your submission), Pawtograder automatically resolves your request with the reason **"grade updated"**. You'll receive a notification explaining what happened.

This is **not** a final resolution — you can still escalate the auto-resolved request to an instructor if you disagree with the updated grade. The original discussion thread is preserved so the instructor has full context.
