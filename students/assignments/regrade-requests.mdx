...
Locate the specific rubric check you want to dispute. Each check has either a **Request regrade** button (if the check was applied and you want it reconsidered) or a **Request regrade** button (if you believe a check should have been applied to your submission but wasn't — shown as "Not applied" in the grade view).
</Step>
...
If a grader re-grades your submission and removes or changes the rubric check that your regrade request was about, your request is automatically resolved with the status **Resolved** and a note that the grade was changed during re-grading.

You'll receive a notification explaining what happened. Review your updated grade and, if you still disagree, you can **escalate** the auto-resolved request to an instructor — auto-resolution is not final.
