...
The very first step is to connect your GitHub account to Pawtograder. Pawtograder will automatically create repositories for your assignments, inside the github.com organization your course uses. Each course has its own organization, so the name you are invited to depends on the course — your instructor can tell you which one to expect.
