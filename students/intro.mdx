...
Pawtograder supports keyboard shortcuts for common navigation tasks. Press **`?`** anywhere in the app to open the shortcuts reference dialog. You can also click the **⌘ (keyboard shortcuts)** button in the top toolbar, or find **Keyboard shortcuts** in the **Support & Documentation** menu.
