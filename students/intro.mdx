...
Your assignments dashboard shows all active assignments for your courses with key information:
...
Once an assignment has been graded and released, you'll see your **total score** displayed directly on the dashboard, making it easy to track your progress across all assignments at a glance.

## Keyboard Shortcuts

Pawtograder supports keyboard shortcuts for common navigation tasks. Press **?** anywhere in the app to open the keyboard shortcuts reference, or click the **keyboard shortcuts button** (⌘ icon) in the top navigation bar. You can also find it under the **Support & Documentation** menu.
