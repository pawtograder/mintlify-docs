...
Pawtograder supports keyboard shortcuts for common actions. To discover available shortcuts:

- Press **?** anywhere in the app to open the keyboard shortcuts overlay.
- Click the **keyboard shortcuts button** (⌘ icon) in the top-right toolbar.
- Open the **Support & Documentation** menu and select **Keyboard shortcuts**.
