...
If you were already a member of the course's GitHub organization before connecting your account (for example, from a previous course), Pawtograder will automatically detect this and clear the invitation banner without requiring you to accept a new invitation.
