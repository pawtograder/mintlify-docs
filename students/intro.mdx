...
<Note>
If you were already a member of the course's GitHub organization before connecting your account (for example, from a previous semester), Pawtograder automatically reconciles your membership on login and the invitation banner clears without requiring you to accept a new invitation.
</Note>
