...
- The floating help request banner that follows you around the site
- The main chat view in your help request

You'll be prompted to select a resolution status to help course staff understand the outcome:
...
- **Resolved - No longer needed**: The request is no longer relevant
