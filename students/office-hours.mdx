...
- **Browser Notifications**: Desktop notifications when staff responds or starts a video call (requires permission)
- **Title Bar Updates**: Your browser tab title shows unread message counts
- **Sound Alerts**: Optional audio notifications for new messages
- **Favicon Badge**: Visual indicator in your browser tab when you have unread messages

You can test notifications and manage your preferences from the help request interface.
...
When you're ready to close your help request, click the "Resolve" button. You'll be asked to indicate how your issue was resolved:
...
When you're ready to mark your help request as resolved, you can do so from:

- The **floating banner** that appears while you have an active request
- The **help request chat view** after receiving assistance

You'll be asked to select a resolution status:

- **Resolved - Got help**: Your question was answered
- **Resolved - Figured it out**: You solved it on your own
- **Resolved - No longer needed**: The issue is no longer relevant

After resolving your request, you can provide feedback on the assistance you received. This feedback is visible only to instructors and helps improve the office hours experience.

You can resolve your own help request at any time from the chat view or the floating help request banner. When you resolve a request, you'll be asked to select a resolution status:

- **Resolved with help**: A staff member helped you solve the problem
- **Resolved on my own**: You figured it out before getting help
- **No longer needed**: The issue is no longer relevant
...
You can also optionally provide feedback on the assistance you received. This feedback is visible only to instructors and helps improve the office hours experience.
