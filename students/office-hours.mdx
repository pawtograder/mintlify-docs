...
When you're ready to close your help request, you can resolve it yourself from the floating banner or main chat view. The resolution flow allows you to:

1. Click **Resolve** from your active help request
2. Select a resolution status that best describes the outcome:
   - **Resolved - Got help**: Staff helped you solve the problem
...
This feedback is visible only to instructors and helps improve the office hours experience.
