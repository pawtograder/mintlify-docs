...
The discussion board supports drag-and-drop image uploads, making it easy to share screenshots, diagrams, or other visual content:
...
3. **Preview**: See the image preview in the editor before posting
4. **Multiple images**: Add multiple images to a single post

Supported image formats include PNG, JPG, GIF, and other common image types. This feature works for both new posts and replies.
