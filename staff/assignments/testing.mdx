...
Clicking a submission link opens it in **student view** — the same read-only experience students see, including grade-release rules, rubric visibility, and hidden autograder output. A banner at the top of the page indicates you are viewing as a student. Click **Exit student view** in the banner to return to the full instructor or grader view of the same submission.
