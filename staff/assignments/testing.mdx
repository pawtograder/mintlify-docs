...
Clicking a submission link on the Test Assignment page opens the submission in **student view** — the same read-only mode used when an instructor views a student's submission as that student. This lets you verify exactly what students will see, including:

- Which autograder tests and output tabs are visible vs. hidden.
- Whether rubric feedback and scores are shown (based on release status).
- The "Submission History" button (not "Commit History") and other student-facing UI.

A banner at the top of the page indicates you are in student view and shows your name. Click **Exit student view** in the banner to return to the full instructor or grader view of the same submission — the page stays on the same submission rather than navigating away.

Both instructors and graders can use this preview. Graders see their own test submissions in student view when clicking from the Test Assignment page.
