...
This applies to both instructors and graders viewing their own test submissions. Use the **Exit student view** button in the banner to return to the full staff view of the same submission, where you can see unreleased scores, hidden test output, and staff-only rubric comments.

<Note>
Student view is a presentation-only mode. Your auth identity and RLS permissions are unchanged — you cannot write data as the student.
</Note>
