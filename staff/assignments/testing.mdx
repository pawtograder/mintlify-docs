...
Clicking a submission link on the Test Assignment page opens the submission in **student view** — the same read-only mode students see, with the same grade-release rules, rubric visibility, and hidden autograder-output behavior. A banner at the top of the page indicates you are viewing as a student.

This applies to both instructors and graders viewing their own test submissions.

To exit student view and return to the full staff view, click **Exit student view** in the banner. The page reloads in the staff view at the same URL, so you can compare what students see versus what staff see side by side.

<Note>
Hidden autograder output, unreleased rubric comments, and staff-only grading controls are not visible while in student view, even for your own test submission.
</Note>
