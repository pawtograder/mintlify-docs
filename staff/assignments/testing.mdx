...
Clicking a submission link on the Test Assignment page opens it in **student view** — the same read-only experience students see. A banner at the top of the page confirms you are in student view and shows your name.

In student view:
- Staff-only controls (commit history, instructor score panel, "Complete Review" button) are hidden.
- Hidden autograder tests and unreleased rubric comments are not shown.
- Only the autograder output and rubric checks that are visible to students appear.
...
Both instructors and graders can use this preview to verify that students see the correct feedback before releasing grades.
