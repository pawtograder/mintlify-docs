...
description: "Test assignments end-to-end with staff repositories and preview the student view before releasing"
icon: "flask-vial"
---

# Testing an Assignment

Pawtograder provides two ways for staff to verify an assignment before students see it: a **test repository** that runs the full autograder pipeline, and a **preview as student** mode that shows exactly what a student sees on the assignment page.

## Preview as student

Use **Preview as student** to see the assignment page exactly as a student would — including the submission panel, group widget, and any PR submission instructions — without creating a repository or triggering the autograder.

On the assignment's **Test Assignment** page, click **Preview as Student**. The page renders the student view using a sample submission context so you can verify instructions, deadlines, and the submission flow before releasing the assignment.

<Note>
Preview as student is read-only. It does not create repositories, record submissions, or affect any student data.
</Note>

## Test repository

The test repository feature provisions staff with a repository just like any other student would have, but it does *not* show up in the list of student submissions. You can even mark up the submission with rubric checks to perform a complete end-to-end test of the assignment.
