...
- Grade-release rules (unreleased rubric scores and comments are hidden)
- Hidden autograder output (staff-only test results are not shown)
- Rubric visibility rules
- The "Viewing as student" banner at the top of the page

This applies to both instructors and graders viewing their own test submissions.

To return to the full staff view, click **Exit student view** in the banner. The page reloads in the instructor or grader view at the same URL, so you can compare what students see versus what staff see side-by-side.
