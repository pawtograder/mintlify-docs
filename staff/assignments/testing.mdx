...
Clicking a submission link on the Test Assignment page opens it in **student view** — the same read-only mode students see, with the same grade-release rules, rubric visibility, and hidden autograder output. A banner at the top of the page indicates you are viewing as a student and shows your name.

This applies to both instructors and graders viewing their own test submissions.

To compare the student view with the full instructor or grader view, click **Exit student view** in the banner. You will be returned to the same submission page in your normal staff role.

## Grading Test Submissions

After exiting student view, the submission page shows the full instructor or grader interface. You can navigate between rubrics (if applicable) from the dropdown in the right sidebar. You can also navigate between submissions (from students or even from other staff members) from the dropdown in the top bar.
