...
Clicking a submission link on the Test Assignment page opens the submission in **student view** — the same read-only mode students see. This lets you verify:

- Which autograder results and rubric items are visible before grades are released.
- That hidden test output and unreleased rubric comments are not exposed.
- How the submission page looks and behaves from a student's perspective.

A banner at the top of the page identifies that you are in student view and shows your name. Click **Exit student view** in the banner to return to the full instructor or grader view of the same submission, where you can see hidden test output, unreleased comments, and grading controls.

Both instructors and graders can use this feature.
