...
## Previewing Test Submissions as a Student

Clicking a test submission link opens the submission in **student view** — the same read-only experience your students see. A banner at the top of the page identifies that you are viewing as a student and shows your name.

In student view:
- Hidden autograder output, unreleased rubric comments, and staff-only test results are not shown.
- Grade-release rules apply: scores and feedback are only visible if the review has been released.
- Instructor-only controls (Commit History, Student's Due Date, Complete Review, etc.) are hidden.

Click **Exit student view** in the banner to return to the full instructor or grader view of the same submission. The page stays on the same submission after you exit, so you can compare the student-facing and staff-facing views side by side.

Both instructors and graders can use this preview for their own test submissions.
