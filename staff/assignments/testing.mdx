...
Clicking a test submission link opens it in **student view** — the same read-only experience your students see. A banner at the top of the page identifies whose submission you are viewing and lets you exit back to the staff view at any time.

In student view:
- Hidden autograder output, unreleased rubric comments, and staff-only test results are filtered out, exactly as they would be for a real student.
- The rubric sidebar shows only what a student would see (no grading controls).
- Commit history and other staff-only panels are hidden.

This lets you verify that the student-facing experience is correct before releasing grades. Click **Exit student view** in the banner to return to the full instructor or grader view of the same submission.

Both instructors and graders can preview their own test submissions in student view.
