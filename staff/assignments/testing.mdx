...
Clicking a submission link on the Test Assignment page opens the submission in **student view** — the same read-only experience students see. This means:

- The **"Viewing as student"** banner appears at the top of the page, showing your name.
...
- Only released, student-visible content is displayed, so you can verify exactly what students will see before releasing grades.

Click **Exit student view** in the banner to return to the full instructor or grader view of the same submission. The page stays on the same submission rather than redirecting to the course home.

Both instructors and graders can use this preview. Graders can preview their own test submissions; instructors can preview any staff test submission.
