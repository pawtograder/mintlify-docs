...
Clicking a submission link on the Test Assignment page opens the submission in **student view** — the same read-only mode students see, with the same grade-release rules, rubric visibility, and hidden autograder output. A banner at the top of the page indicates you are viewing as a student and shows your name.

This applies to both instructors and graders viewing their own test submissions.

To exit student view and return to the full instructor or grader interface, click **Exit student view** in the banner. You are returned to the same submission page so you can compare the two views side by side.
