...
For group assignments, instructors can export group information as a CSV file. The export includes:

- **Group name**: The name of each group
- **Student names and emails**: All group members in "Name <email>" format
- **Mentor name and email**: The assigned mentor (if applicable) in "Name <email>" format
