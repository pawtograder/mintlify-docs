...
You can export group data to CSV for external analysis or record-keeping. The export includes:
- Group name
- Student names and emails (formatted as "Name <email>")
- Mentor name and email (if assigned)

The CSV uses UTF-8 encoding with BOM for Excel compatibility and includes formula-safe escaping for security.
