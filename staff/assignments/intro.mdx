...
You can export group information to CSV for record-keeping or analysis. The export includes:

- Group name
- Student names and email addresses (in "Name <email>" format)
- Mentor/grader name and email address (in "Name <email>" format)

To export group data, navigate to the assignment's group management page and click the "Export Groups" button. The CSV file includes UTF-8 encoding with BOM for proper display in Excel and other spreadsheet applications.
