...
Instructors and graders can also manually grant extensions to students, gift additional late tokens, and view all extensions granted to a student. This is done in the assignment configuration under "Due Date Exceptions".

## Repository Analytics

Pawtograder provides repository analytics for assignments, allowing instructors to view commit history, contribution patterns, and activity metrics for student repositories. This helps instructors understand student engagement and identify potential issues with group collaboration or assignment progress.
