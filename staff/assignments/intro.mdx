...
Pawtograder provides analytics for assignment repositories, allowing instructors to track student engagement and progress. You can view metrics such as commit frequency, file changes, and repository activity patterns to understand how students are working on assignments. This helps identify students who may need additional support or are struggling with the assignment.
...
For group assignments, instructors can enable individual grading within groups. This allows you to assign different grades to different group members based on their individual contributions, while still maintaining the group submission structure. This is useful for peer evaluation scenarios or when group members contribute unequally to the assignment.
