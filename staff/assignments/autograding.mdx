...
<CardGroup cols={2}>
  ...
  <Card title="Limiting Feedback" icon="eye-slash" href="#limiting-student-visible-feedback">
    Trim what students see with `maxImplementationHints` and `hide_output`.
  </Card>
  <Card title="Feedbot" icon="message-bot" href="#feedbot">
    LLM-generated hints attached to failing tests.
  </Card>
  <Card title="Examples" icon="code" href="#examples">
    Working `pawtograder.yml` files for Java, Python, and mutation testing.
  </Card>
  <Card title="Submission Validation" icon="circle-check" href="#submission-file-pattern-validation">
    Pattern validation and empty-submission detection.
  </Card>
  <Card title="Submission Viewer" icon="folder-open" href="#submission-file-viewer">
    How files and grader artifacts render in the UI.
  </Card>
  <Card title="AI-Powered Test Hints" icon="wand-magic-sparkles" href="#ai-powered-test-hints">
    Per-test `extra_data.llm` blocks for one-shot hints.
  </Card>
