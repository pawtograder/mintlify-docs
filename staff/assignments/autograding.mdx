...
<Note>
The autograder is optional. If you want students to have a GitHub repository but prefer to grade by hand without any GitHub Actions workflow, disable the autograder on the assignment's **Autograder** page. See [Configuration](/staff/assignments/configuration) for details on repo-only assignments.
</Note>
