...
If any selected reviews are not yet marked complete, a warning dialog
appears before publishing. You can:

- **Cancel** — go back without releasing anything.
- **Review** — jump to the submissions table filtered to incomplete reviews so you can finish grading first.
- **Continue anyway** — release all selected reviews, including incomplete ones.

The same warning appears on the **Release all** button in the Grading Status panel and on the per-submission **Release** button.
...
- **Graders** can mark a review complete or update it as long as it is not both released *and* already marked complete. Once a released review is complete, graders cannot revert it to incomplete.
- **Instructors** can mark any review complete or incomplete at any time, even after release.

When a grader or instructor marks a review complete after it has already been released to students, a warning toast is shown to confirm the action.
