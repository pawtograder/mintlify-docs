...
If any of the selected reviews are not yet marked complete, a warning dialog appears before the release proceeds. You can cancel, navigate to the incomplete reviews to finish grading, or continue releasing anyway. See [Releasing incomplete reviews](/staff/assignments/grading-assignments#releasing-incomplete-reviews) for details.
