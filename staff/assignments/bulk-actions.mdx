...
- **Review** — jump to the table filtered to incomplete reviews so you can finish grading first.
- **Continue anyway** — release all selected reviews including the incomplete ones.

The same warning appears on the **Release all** button in the Grading Status panel.
