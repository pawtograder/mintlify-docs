...
If any selected reviews are not yet marked complete, Pawtograder shows a warning dialog before releasing. You can:

- **Cancel** — return to the table without releasing.
- **Review** — jump to the submissions table filtered to incomplete reviews so you can finish grading before releasing.
- **Continue anyway** — release all selected reviews, including incomplete ones.

The same warning appears when using **Release all** from the grading status panel.
