...
If students were given both an individual repository and a group repository by mistake (for example, groups were configured after the assignment was released), you can use the **Cleanup individual repositories** button to remove the individual repositories.
...
<Warning>
This operation cannot be undone. Only individual repositories (those without a group assignment) are affected. Group repositories remain intact.
</Warning>

The button is disabled when there are no individual repositories for the assignment.
