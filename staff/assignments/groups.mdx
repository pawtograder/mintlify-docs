...
When you remove all members from a group (making it empty), Pawtograder checks whether the group's repository contains any submissions. If it does, the repository is preserved and the group is kept in a dormant state rather than deleted. This prevents accidental data loss when restructuring groups mid-assignment.
