...
The **All regrade requests** dashboard gives instructors a single view of every regrade request across all assignments in the course, without having to navigate to each assignment individually.
...
Click **Open** on any row to jump directly to the submission's files view with the regrade request highlighted.
