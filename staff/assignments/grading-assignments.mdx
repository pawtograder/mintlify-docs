...
## Releasing and Unreleasing Grading Reviews

From the assignment's submissions table, you can release or unrelease grading reviews for selected submissions in bulk.

### Selecting submissions

The submissions table includes a checkbox column on the left. Use it to:

- **Select individual rows**: Click the checkbox on any row with an active submission.
- **Select all in view**: Click **All in view** in the column header to select every row that matches the current filters.
- **Clear selection**: Click **None** in the column header to deselect all rows.

Rows without an active submission (students who have not yet submitted) cannot be selected.

### Bulk release and unrelease

Once you have selected one or more rows, the **Release** and **Unrelease** buttons in the toolbar become active and show the number of selected submissions. Click the appropriate button to release or unrelease grading reviews for all selected submissions at once.

- **Release _N_ selected submissions**: Marks the grading review for each selected submission as released, making feedback visible to students.
- **Unrelease _N_ selected submissions**: Hides feedback from students for each selected submission.

After the operation completes, the selection is cleared automatically.

<Tip>
Use column filters (for example, filter by grader or section) before clicking **All in view** to release feedback for a specific subset of students.
</Tip>
