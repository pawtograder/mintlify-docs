...
The **All regrade requests** dashboard gives instructors a single view of every regrade request across all assignments in the course.

### Accessing the dashboard

From the **Manage → Assignments** page, click **All regrade requests** in the toolbar. You can also navigate directly to `/course/[id]/manage/regrade-requests`.

### What the dashboard shows

The table displays all regrade requests with columns for:

- **Status**: Draft, Pending, Escalated, Resolved, or Closed
- **Assignment**: Links to the per-assignment regrade requests page
- **Rubric Check**: The rubric check the request is about
- **Student/Group**: The submitter, with an **Open** link to the submission files at the regrade request anchor
...
- **Discord**: Link to the Discord thread for the request (if any)
- **Created / Last Updated**: Timestamps

### Filtering

By default, the dashboard shows only **opened** and **escalated** requests (active requests). Use the **Filter by Status** dropdown to include draft, resolved, or closed requests. Additional filters are available for assignment, student, rubric check, assignee, and escalation outcome.
