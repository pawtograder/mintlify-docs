...
The new grader will be notified of their assignment, and the previous grader will be notified that the task has been reassigned. Any work completed by the previous grader will be preserved and visible to the new grader.

<Note>
Pawtograder automatically allows any grader to complete a task even if it's assigned to someone else, without requiring formal reassignment. Use the reassignment feature when you want to explicitly change responsibility and notify both graders.
</Note>
