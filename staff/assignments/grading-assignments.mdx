...
### Including students without a submission

By default, students and groups who have not yet submitted are excluded from bulk grading assignment. Enable **Assign grading for all students** to include them: Pawtograder creates empty stub submissions for non-submitters (respecting any section, lab, or tag filters you have applied) before running the assignment algorithm. This is useful when you want to ensure every enrolled student has a grader assigned, even if they have not submitted yet.
