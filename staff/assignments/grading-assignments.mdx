...
- **Rubric check**: Filter by the rubric item being contested
...
By default, draft and resolved requests are hidden. Adjust the **Status** filter to include them.

### Opening a request

Click **Open** on any row to go directly to the submission's files view with the regrade request highlighted.
