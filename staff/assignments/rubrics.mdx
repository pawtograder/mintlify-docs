...
This is most useful for self-review rubrics: students should not see the self-review questions before they submit their programming assignment, because seeing the questions in advance could bias their work. With `hide_unless_assigned: true`, the rubric is invisible until Pawtograder assigns the self-review to the student (after their submission deadline passes).
