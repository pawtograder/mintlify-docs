...
When editing a rubric, Pawtograder will warn you before leaving the page if you have unsaved changes. This prevents accidental loss of work when navigating away from the rubric editor.
...
Click **Save** to preserve your changes before navigating away, or **Cancel** to discard changes and leave the page.

When editing rubrics, the system tracks unsaved changes and warns you before navigating away to prevent accidental data loss.
...
The rubric editor automatically detects unsaved changes and prevents accidental data loss:
