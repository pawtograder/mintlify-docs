...
3. Select the student or group who needs an extension
...
### Course-wide exceptions table

The **Manage → Course → Due Date Extensions → Assignment Exceptions** page shows all due date exceptions across every assignment in the course in a single virtualized table. You can filter by assignment, student, and token usage, and delete exceptions directly from the table. This replaces the previous per-assignment accordion view and performs significantly better for large courses.
