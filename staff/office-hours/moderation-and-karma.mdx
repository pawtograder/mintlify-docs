...
<Warning>
A ban is an interface-level deterrent, not a hard access control. It takes away the office hours pages and the chat composer, but it does not revoke the student's access to the course, and a determined student is not shut out by it. Treat moderation as a course-policy tool, and do not rely on a ban to keep someone out.
</Warning>
