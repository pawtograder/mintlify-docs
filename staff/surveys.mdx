...
You can link surveys to specific assignments to collect feedback about that assignment. When a survey is linked to an assignment:

1. Navigate to the survey settings
2. Select **Link to Assignment** option
3. Choose the assignment from the dropdown list
4. The survey will be associated with that assignment for organizational purposes

This helps organize feedback collection and allows you to track survey responses in the context of specific assignments.

### Group Mentors

For group assignments, you can assign mentors to student groups. Mentors can view survey responses from their assigned groups and provide guidance. To assign mentors:

1. Navigate to the assignment's group management page
2. Select a group
3. Click **Assign Mentor**
4. Choose a staff member to serve as the group's mentor
5. The mentor will have access to view survey responses and analytics for their assigned groups
