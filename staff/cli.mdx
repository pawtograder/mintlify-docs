...
`help-requests close` is the only way to set a help request's status to `closed`. Nothing in the web interface does it, and the command is restricted to instructors.
