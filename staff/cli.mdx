...
npm run cli -- assessment export \
  --class cs3500-fall-2025 \
  --identity hash \
  --salt "your-secret-salt-at-least-16-chars"
...
# Export with autograder test output included
npm run cli -- assessment export \
  --class cs3500-fall-2025 \
  --with-test-output \
...
- `subjects.json` — Student roster (tokenized or raw)
...
<Warning>
The deanonymize command writes real student PII to disk. Handle the output file with appropriate care.
</Warning>
