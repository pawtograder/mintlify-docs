...
Karma is part of the Discussion feature rather than a separate setting. It is active in any course where Discussion is enabled under **Course Settings → Feature flags**, and there are no karma weights or other karma options to configure. Turning the Discussion flag off hides the discussion board from the course menu for everyone, karma included.
