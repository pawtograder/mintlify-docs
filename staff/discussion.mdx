...
Instructors and staff can mark a discussion thread as a duplicate of another thread. This is useful when students post the same question multiple times or when a new thread covers a topic already addressed elsewhere.

### How to mark a thread as a duplicate

1. Open the thread you want to mark as a duplicate.
2. Click the **Mark as Duplicate** option in the thread actions menu.
3. Search for and select the original thread that this one duplicates.
4. Confirm the action.

Once marked, the duplicate thread displays a banner at the top linking students to the original thread. This helps consolidate discussion and ensures students find the canonical answer without staff needing to repeat themselves.

<Note>
Only instructors and staff can mark threads as duplicates. Students will see the duplicate banner and a link to the original thread, but cannot mark or unmark duplicates themselves.
</Note>
