...
4. Select the original thread and click **Merge into original**.
...
- The author of the duplicate thread receives an in-app notification (and email when the queue processor runs) with a link to their post under the original thread.
