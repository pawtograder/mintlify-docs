...
Pawtograder supports keyboard shortcuts for common navigation tasks. To discover available shortcuts:

- Press `?` anywhere in the application to open the shortcuts overlay.
- Click the **⌘** (keyboard shortcuts) button in the course header toolbar.
