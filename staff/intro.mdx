...
Pawtograder supports keyboard shortcuts for common navigation and grading actions. To discover available shortcuts:

- Click the **keyboard shortcuts button** (⌘ icon) in the top-right toolbar of any course page, or
- Open the **Support & Documentation** menu and select **Keyboard shortcuts**, or
- Press **?** anywhere in the app.

The shortcuts dialog lists all available shortcuts for the current context.
