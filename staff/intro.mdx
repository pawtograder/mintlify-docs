...
Pawtograder supports keyboard shortcuts for common navigation actions. To discover available shortcuts:

- Click the **keyboard shortcuts button** (⌘ icon) in the top-right toolbar, or
