...
Pawtograder supports keyboard shortcuts for faster navigation. Press **`?`** anywhere in the course to open the keyboard shortcuts overlay. You can also access it from:

- The **keyboard shortcuts button** (⌘ icon) in the course header toolbar
- The **Support & Documentation** menu → **Keyboard shortcuts**
