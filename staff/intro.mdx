...
Pawtograder supports keyboard shortcuts for common navigation and actions. You can discover available shortcuts in two ways:

- **Toolbar button**: Click the **keyboard shortcuts** button (⌘ icon) in the top-right toolbar of any course page.
- **Support menu**: Open the **Support & Documentation** menu and select **Keyboard shortcuts**.
- **Keyboard**: Press **?** at any time to open the shortcuts overlay.

The shortcuts overlay lists all available shortcuts for the current context. Press **Escape** to close it.
