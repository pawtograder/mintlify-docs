...
## Getting added to a course

Platform administrators create courses and add instructors via the admin portal. When creating a new course, admins can:

- Select the **GitHub organization** from a dropdown of orgs where the Pawtograder GitHub App is installed.
- Add **instructors by email** at creation time. If the email matches an existing Pawtograder user, their name is pre-filled automatically; otherwise the admin enters the name manually.

If you need to be added to a course or if your course's GitHub organization is not listed, contact your platform administrator.
